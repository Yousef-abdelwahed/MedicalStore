...
<?php
   ...
   <center>
  <main>
    <div class="form-container contan">
        <form class="form" action="up.php" method="post" enctype="multipart/form-data">
          <div class="form-group">
            <label for="input-name">Product ID</label>
            <input type="text" name="id" id="input-name"  value="<?php echo $data['id'] ?>" readonly>
            <br>
          ...
          <div class="form-group">
            ...
            <input type="text" name="price" id="input-price" value="<?php echo $data['price'] ?>">
       ...
       <div class="file-input">
            <input type="file" name="image" id="file" class="file">
             ...
             <br>
             <input type="submit" value="Modify the product" name="update" class="form-submit-btn"> 
             <!-- <button class="form-submit-btn" name="update" type="submit">Modify the product</button> -->
       </div>
       <div>
